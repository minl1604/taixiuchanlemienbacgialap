...
## Tổng quan
**Tài Xỉu Miền Bắc Giả Lập** là một ứng d���ng web client-side mô phỏng "Giải Đặc Biệt" của Xổ Số Miền Bắc chỉ dành cho mục đ��ch giải trí. Đây là một trình giả lập **KHÔNG** có thật, mọi kết quả đều đ��ợc tạo ngẫu nhiên trên trình duyệt của bạn.
...
-   **Ch��� độ quay tự động 20 giây**: Với đồng hồ đếm ngược neon và hiệu ứng âm thanh "tick" cho mỗi giây.
...
-   **Xu hướng soicau**: Biểu đồ grid động hi��n thị kết quả theo cột, với tooltip chi tiết khi hover.
...
## 🎮 Cách Chơi Chi Tiết
1.  **Bắt đầu**: Khi mở ứng dụng, bạn sẽ thấy kỳ quay hiện tại và đồng hồ đếm ngược. Bạn có một số dư ảo để bắt đầu.
2.  **Chọn Chế độ**: Trong khu vực "Dự đoán kỳ này", bạn có thể chọn giữa hai chế độ: **Tài/Xỉu** hoặc **Chẵn/Lẻ**. Trên di động, bạn có thể lướt ngang để chuyển đổi nhanh chóng.
3.  **Chọn Dự đoán**: Nhấn vào nút tương ứng (ví dụ: "Tài" hoặc "Chẵn") để chọn dự đoán của bạn.
4.  **Đặt cược**: Nhập số tiền ảo bạn muốn cược vào ô "Số tiền cược".
5.  **Quay số**:
    -   **Tự động**: Nhấn "Bắt đầu Auto" để hệ thống tự động quay một kỳ mới sau mỗi 20 giây.
    -   **Thủ công**: Nhấn "Đặt cược & Quay" để có kết quả ngay lập tức.
6.  **Xem Kết quả**: Sau khi quay, kết quả sẽ hiển thị ở khu vực "Kỳ hiện tại". Nếu bạn thắng, hiệu ứng pháo hoa sẽ xuất hiện và số dư của bạn sẽ được cập nhật.
7.  **Theo dõi**: Các bảng "Xu Hướng", "Kết quả gần đây" và "Thống kê" sẽ tự động cập nhật sau mỗi kỳ.
## 🖼️ Hình Ảnh Minh Họa
...
-   **Dữ liệu**: Mọi thứ được lưu vào `localStorage`. D�� liệu sẽ mất nếu bạn dùng chế độ ẩn danh hoặc xóa bộ nhớ trình duyệt.
...
-   **Âm thanh không tự động phát**: Hầu hết các trình duyệt hiện đại yêu cầu người dùng tương tác với trang (nhấp chuột, chạm) trước khi âm thanh có thể được phát. Hãy nhấp vào bất kỳ đâu trên trang để kích hoạt âm thanh.
## 🏗️ Phát triển
...
## 📄 Giấy Phép
Dự án này được cấp phép theo giấy phép MIT. Mã nguồn được cung cấp "nguyên trạng" và chỉ dành cho mục đích học tập và giải trí. Tác giả không ch���u trách nhiệm cho bất kỳ việc sử dụng sai mục đích nào. **Không dành cho cờ bạc tiền thật.**
---
