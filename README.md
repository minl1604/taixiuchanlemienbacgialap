...
Ứng dụng không sử dụng dữ liệu xổ số thật, không liên quan đến tiền bạc, cá cược hay ví điện tử. Mục tiêu chính là mang lại trải nghiệm vui vẻ, giúp bạn thử vận may và theo dõi các xu hướng một cách an toàn. Mọi dữ liệu (lịch sử, thống k��) đều được lưu trữ cục bộ trong `localStorage` của trình duyệt.
...
-   **Thành tích tự động**: M�� khóa các huy hiệu khi đạt các cột mốc (chuỗi thắng, số kỳ đã ch��i).
...
2.  **Ch���n Chế độ**: Trong khu vực "Dự đoán kỳ này", bạn có thể chọn giữa hai chế độ: **Tài/Xỉu** hoặc **Chẵn/Lẻ**. Trên di động, bạn có thể lướt ngang để chuyển đổi nhanh chóng.
3.  **Chọn Dự đoán**: Nhấn vào nút tương ứng (ví dụ: "Tài" hoặc "Chẵn") để chọn dự đoán của bạn.
4.  **Đặt cược**: Nhập số tiền ảo bạn muốn cược vào ô "Số tiền cược" (mặc định 500,000,000 VND).
5.  **Quay số**:
...
-   **Dữ liệu bị hỏng hoặc ứng dụng không hoạt động đ��ng**:
